...
ENV_ASSET_DIR_DISPLAY = os.path.join(os.path.dirname(__file__), 'assets_display')
def full_display_path_for(file_name):
    return os.path.join(ENV_ASSET_DIR_DISPLAY, file_name)
